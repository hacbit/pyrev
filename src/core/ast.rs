                ...
                Opcode::StoreName | Opcode::StoreFast | Opcode::StoreGlobal => {
                    ...
                    match value {
                        ...
                        ExpressionEnum::Import(import) => {
                            if import.bk_module == None {//没from
                                if import.module == name  { //没from，没as
                                ...
                                if import.fragment.as_ref().ok_or("[StoreName-import]")? == &name {//有from，无as
                                    exprs_stack.push(ExpressionEnum::Import(Import{
                                        module: import.module,
                                        bk_module: Some(import.bk_module.expect("")+ &name.clone() + ","),
                                        alias: None,
                                        fragment:None,
                                    }))
                                }
                                    ...
                                    exprs_stack.push(ExpressionEnum::Import(Import{
                                        module: import.module,
                                        bk_module: Some(import.bk_module.expect("")+import.fragment.as_ref().ok_or("[StoreName-import]")?+" as "+ &name.clone() + ","),
                                        alias: None,
                                        fragment:None,
                                    }))
                                }
                             ...
                             /*
                             if import.module == name//没as 
                            {
                                if import.bk_module == None{//没as，没from
                                    exprs_stack.push(ExpressionEnum::Import(Import{
                                        module: import.module,
                                        bk_module: None,
                                        alias: None,
                                ...
                                if import.bk_module == None{//有as，没from
                                    exprs_stack.push(ExpressionEnum::Import(Import{
                                        module: import.module,
                                        bk_module: None,
                                        alias: Some(name),
                                    ...
                                    exprs_stack.push(ExpressionEnum::Import(Import{
                                        module: import.module,
                                        bk_module: Some(import.bk_module.expect("")+" as "+ &name.clone() + ","),
                                        alias: None,
                                        fragment:None,
                                    }))
                                }
